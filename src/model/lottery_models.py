...
class AlgorithmRecommendation:
    ...
    algorithm_parameters: Optional[Dict[str, Any]] = None  # 算法参数配置
    model_weights: Optional[Dict[str, float]] = None  # 模型权重配置
    analysis_basis: Optional[Dict[str, Any]] = None  # 分析依据数据
    key_patterns: Optional[List[str]] = None  # 关键模式识别
...
class RewardPenaltyRecord:
    ...
    hit_details: Optional[Dict[str, Any]] = None  # 命中详情
    missed_numbers: Optional[List[int]] = None  # 未命中号码分析
...
class ABTestConfig:
    ...
    test_description: Optional[str] = None  # 测试描述
